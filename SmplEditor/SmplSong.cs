...
namespace SmplEditor
{
    public class SmplSong
    {
        ...
        public SmplSong DeepCopy() //!!do I need a deepcopy?
        {
            SmplSong copy = new SmplSong();
        ...
        public static bool DeepCompareSongs(SmplSong x, SmplSong y, bool strict = true) //!!why do I need this?
        {
            bool result = true;
            if (strict)
            {
